class FilaDuplaTerminacao(private val tamanho: Int = 10) : Enfileiravel {
    ...
    //retorna o dado no inicio da fila
    ...
    //enfileira um novo dado no inicio da fila
