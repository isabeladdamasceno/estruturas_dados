...
// Árvore binária de heap (monte) = árvore completa à esquerda e pode ter até dois filhos. Ela possui dois tipos: máximo e mínimo. 
// facilita a localização do máximo em tempo constante e fornece uma estrutura eficiente para operações de prioridade, como extrair o máximo.
